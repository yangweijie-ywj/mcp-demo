    ...
    tools = [{
        "mcpServers": {
            "amap-maps": {
                ...
                "env": {
                    "AMAP_MAPS_API_KEY": "3bc6a000fb4b0f39b495aafd624a9476"
                }
            },
            "fetch": {
                "type": "sse",
                "url": "https://mcp.api-inference.modelscope.net/5b48fb58285243/sse"
            },
            "bing-cn-mcp-server": {
                "type": "sse",
                "url": "https://mcp.api-inference.modelscope.net/089c150b949b4c/sse"
            },
            "tavily-mcp": {
                "type": "sse",
                "url": "https://mcp.api-inference.modelscope.net/85737110947742/sse"
            }
        }
    }]
